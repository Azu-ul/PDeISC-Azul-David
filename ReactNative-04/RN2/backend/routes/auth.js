          ...
          <body>
            <script>
              ...
              if (window.opener) {
                ...
                window.location.href = '${process.env.CLIENT_URL}?error=account_exists&provider=${provider}';
              }
            </script>
          </body>
        </html>
          ...
          <body>
            <script>
              if (window.opener) {
                ...
                window.location.href = '${process.env.CLIENT_URL}?error=auth_failed';
              }
            </script>
          </body>
        </html>
            ...
            <script>
              ...
              try {
                if (window.opener) {
                  ...
                  window.location.href = '${process.env.CLIENT_URL}?token=${token}&user=${userData}';
                }
              } catch (error) {
